...
public class Principal {
    public static void main(String [] args){
        ...
        calificacionesArchivo=extraerDatosArchivo("practica9.csv",',');
    ...
    private static String[] extraerDatosArchivo(String documento, char separador){
        ...
        try{
            ...
            ClaseIO.imprimirMensaje("ERROR: Error en el flujo de archivo!");
        }finally {
            if(fileInputStream != null) {
                try {
                    fileInputStream.close();
                } catch (IOException e) {
                    ClaseIO.imprimirMensaje("ERROR: Flujo de documento no se pudo cerrar correctamente!");
                }
            }
        }
    ...
    private static void guardardatos(String nombreSalidaDocumento, Object[] objetoAGuardar){
        FileOutputStream archivoSalida = null;

        try{
            archivoSalida = new FileOutputStream(nombreSalidaDocumento + ".txt");
